    ...
    var optionslinechart = {
        ...
        colors:[creativeAdminConfig.primary],
...
var optionssaleschart = {
    ...
    colors:[creativeAdminConfig.primary, creativeAdminConfig.secondary, '#544fff'],
    chart: {
        height: 300,
        type: 'radar',
        dropShadow: {
...
var optionsuserchart = {
    ...
    colors:[creativeAdminConfig.primary, creativeAdminConfig.secondary, '#51bb25', '#544fff'],
    title: {
...
// browser-candlestick chart
    var optionscandlestickchart = {
        ...
        plotOptions: {
            candlestick: {
                colors: {
                    upward: creativeAdminConfig.primary,
                    downward: creativeAdminConfig.secondary
                }
            }
        },
        fill: {
...
// realtime chart
    ...
    var optionsProgress1 = {
        ...
        fill: {
            ...
            type: 'gradient',
            gradient: {
                gradientToColors: [creativeAdminConfig.primary]
            }
        },
        series: [{
            name: 'Process 1',
    ...
    },
    {
        ...
        chartProgress3.updateOptions({
         ...
         var p4Data = getRangeRandom({ min: 5, max: 100 });
        ...
        var p5Data = getRangeRandom({ min: 5, max: 100 });
